...
| **Localization Foundation** | Core navigation, Settings, Locations, Compare, widgets, and Wear OS state copy use Android string resources with an initial Spanish resource set |
