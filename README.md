...
| **Localization Foundation** | Core navigation, Settings, Custom Alerts, Locations, Compare, widgets, and Wear OS state copy use Android string resources with an initial Spanish resource set |
