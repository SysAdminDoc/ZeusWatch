...
| **Localization Foundation** | Core navigation, Settings, Locations, Compare, and Wear OS state copy use Android string resources with an initial Spanish resource set |
