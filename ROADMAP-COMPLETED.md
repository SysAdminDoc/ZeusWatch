...
| v1.17.0 | Provider expansion + security hardening + a11y — MET Norway forecast adapter (uncontested Nordic coverage via LocationForecast 2.0), Environment Canada forecast adapter (unstub, via citypageweather-realtime OGC API Features), TLS pinning scaffolding for OWM/Pirate Weather with `tools/capture_api_pins.sh`, widget freshness pill tap-to-refresh, Canvas a11y semantics on AqiGauge/TemperatureGraph/PressureTrendCard/MoonPhaseCard/CloudCoverCard, 20+ new test assertions | 2026-04-24 |
